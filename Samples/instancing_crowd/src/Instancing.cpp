...
#endif
{
	...
	void InstancingListener::burnCPU(void)
	{
		...
		{
			mWindow->setDebugText("remaining for logic:"+ StringConverter::toString(time));
	...
	void InstancingListener::createInstanceGeom()
	{
		...
		while (regIt.hasMoreElements ())
		{
			...
			InstancedGeometry::InstanciedObject **objects= r->getObjectsAsArray(objectCount);
	...
	//-----------------------------------------------------------------------
	void InstancingListener::setShaderType(InstancedGeometry::BatchInstance::ShaderType type)
	{
	...
	//-----------------------------------------------------------------------
	void InstancingListener::mouseMoved (Ogre::MouseEvent *e)
{
	...
	//-----------------------------------------------------------------------
   void InstancingListener::mouseDragged (MouseEvent *e) 
   { 
       mouseMoved(e);
   }
	//-----------------------------------------------------------------------
   void InstancingListener::mousePressed (MouseEvent *e)
   {
	...
	//-----------------------------------------------------------------------
   void InstancingListener::mouseReleased (MouseEvent *e)
   {
   ...
   void InstancingListener::mouseClicked(MouseEvent* e) {}
   void InstancingListener::mouseEntered(MouseEvent* e) {}
   void InstancingListener::mouseExited(MouseEvent* e) {}
