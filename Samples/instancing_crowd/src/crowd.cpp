...
#endif
{
	...
	//-----------------------------------------------------------------------
	void CrowdListener::mouseMoved (Ogre::MouseEvent *e)
{
	...
	//-----------------------------------------------------------------------
   void CrowdListener::mouseDragged (MouseEvent *e) 
   { 
       mouseMoved(e);
   }
	//-----------------------------------------------------------------------
   void CrowdListener::mousePressed (MouseEvent *e)
   {
	...
	//-----------------------------------------------------------------------
   void CrowdListener::mouseReleased (MouseEvent *e)
   {
   ...
   void CrowdListener::mouseClicked(MouseEvent* e) {}
   void CrowdListener::mouseEntered(MouseEvent* e) {}
   void CrowdListener::mouseExited(MouseEvent* e) {}
