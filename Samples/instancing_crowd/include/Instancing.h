...
class InstancingListener : public ExampleFrameListener, Ogre::MouseMotionListener, Ogre::MouseListener
{
protected:
...
protected:
   ...
   CEGUI::Window* mEditorGuiSheet;
	...
	bool handleLightingChanged(const CEGUI::EventArgs& e)
	{
		...
		if(((CEGUI::Checkbox*)((const CEGUI::WindowEventArgs&)e).window)->isSelected())
		{
			static_cast<InstancingListener*>(mFrameListener)->setShaderType(InstancedGeometry::BatchInstance::ShaderType::ST_VERTEX_L);
		}
		else
		{
			static_cast<InstancingListener*>(mFrameListener)->setShaderType(InstancedGeometry::BatchInstance::ShaderType::ST_VERTEX_U);
		}
		return true;
	}
	//-----------------------------------------------------------------------
