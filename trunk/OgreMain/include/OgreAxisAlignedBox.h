    ...
    protected:
        ...
        */
        void updateCorners(void)
        {
            ...
            //   around face (looking onto the face)
            mCorners[0] = mMinimum;
            mCorners[1] = Vector3( mMinimum.x, mMaximum.y, mMinimum.z );
            mCorners[2] = Vector3( mMaximum.x, mMaximum.y, mMinimum.z );
            mCorners[3] = Vector3( mMaximum.x, mMinimum.y, mMinimum.z );

            mCorners[4] = mMaximum;
            mCorners[5] = Vector3( mMinimum.x, mMaximum.y, mMaximum.z );
            mCorners[6] = Vector3( mMinimum.x, mMinimum.y, mMaximum.z );
            mCorners[7] = Vector3( mMaximum.x, mMinimum.y, mMaximum.z );
        }        
