...
namespace Ogre {
    /** Class encapsulates rendering properties of an object.
        ...
        @par
            ...
            rather like 3D Studio's material. It also includes other flags which might not
            be traditionally thought of as material properties such as culling modes and depth buffer
            settings, but these affect the appearance of the rendered object and are convenient to
            attach to the material since it keeps all the settings in one place. This is different
            to Direct3D which treats a material as just the colour components (diffuse, specular)
            and not texture maps etc. An Ogre Material can be thought of as equivalent to a 'Shader'.
        @par
            Ogre comes configured with a number of default settings for a newly created material. These can be
            changed if you wish by retrieving the default material settings through SceneManager::getDefaultMaterialSettings.
            Any changes you make to the Material returned from this method will apply to any materials created from this
            point onward.
        @todo
    ...
    */
        ...
        public:
            ...
            */
            ...
            protected:
                ...
                int mNumFrames;        // Number of frames of animation, or frames making up cubic
                String mFrames[MAX_FRAMES]; // Names of frames
                int mCurrentFrame;
                Real mAnimDuration;            // Duration of animation in seconds
    ...
    protected:
        ...
        // Textures
        //std::vector<TextureLayer> mTextureLayers;
        // No longer dynamic, for efficiency
