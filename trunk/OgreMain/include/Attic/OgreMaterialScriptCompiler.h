...
namespace Ogre {
    ...
    private:
	    ...
	    enum SymbolID {
			...
			mid_EMISSIVE_DEF, mid_SPECULAR_DEF, mid_SCENE_BLEND_DEF, mid_DEPTH_CHECK_DEF, mid_DEPTH_WRITE_DEF,
            ...
            mid_VERTEX_PROGRAM_REF_DEF, mid_SHADOW_CASTER_VERTEX_PROGRAM_REF_DEF,
