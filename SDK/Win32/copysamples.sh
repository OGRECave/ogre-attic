...
cp ../../ReferenceApplication/ReferenceAppLayer/scripts/*.cbp samples/refapp/scripts
...
rm samples/scripts/OgreGUIRenderer.cbp
rm samples/scripts/OgreGUIRenderer.vcproj
rm samples/scripts/OgreGUIRenderer_vc8.vcproj
/bin/find samples/scripts/ -iname *.cbp -exec sed -i -f altersamples.sed \{\} \;
...
/bin/find samples/refapp/scripts/ -iname *.cbp -exec sed -i -f alterrefapp.sed \{\} \;
