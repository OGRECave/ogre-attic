...
namespace Ogre {
    ...
    */
    ...
    public:
        ...
        */
        virtual size_t getNumMipmaps(void) const {return mNumRequestedMipmaps;}

		/** Gets the number of mipmaps actually generated by the hardware (only
			correct after load() or createInternalResources())
		*/
		virtual size_t getNumActualMipmaps(void) const {return mNumMipmaps;}
