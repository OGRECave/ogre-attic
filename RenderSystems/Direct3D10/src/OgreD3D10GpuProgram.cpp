...
namespace Ogre {
    ...
    {
		String message = "AIZ:Cannot assemble D3D10 shader " + mName + " Errors:\n" ;
    ...
    D3D10GpuVertexProgram::D3D10GpuVertexProgram(ResourceManager* creator, 
        ...
        bool isManual, ManualResourceLoader* loader, ID3D10Device * pDev) 
        : D3D10GpuProgram(creator, name, handle, group, isManual, loader, pDev)
        , mpVertexShader(NULL)
    {
