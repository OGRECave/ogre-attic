...
namespace Ogre {
    ...
    public:
        D3D10GpuProgram(ResourceManager* creator, const String& name, ResourceHandle handle,
            const String& group, bool isManual, ManualResourceLoader* loader, ID3D10Device * pDev);
        ...
        */ 
        void setExternalMicrocode(ID3D10Blob *  pMicrocode) { mpExternalMicrocode = pMicrocode; }
        /** Gets the external microcode buffer, if any. */
        ID3D10Blob *  getExternalMicrocode(void) { return mpExternalMicrocode; }
    protected:
    ...
    public:
        ...
        ID3D10VertexShader * getVertexShader(void) const { return mpVertexShader; }
    protected:
    ...
    public:
        ...
        ID3D10PixelShader * getPixelShader(void) const { return mpPixelShader; }
    protected:
        /** @copydoc Resource::unloadImpl */
        void unloadImpl(void);
        void loadFromMicrocode(ID3D10Blob *  microcode);
